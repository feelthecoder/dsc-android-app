...
import com.feelthecoder.dsc.Model.MembersInfo;
...
board_progress=findViewById(R.id.board_progress);
        ...
        connect = findViewById(R.id.no_connect_board_ee);
        ...
        getSupportActionBar().setTitle("The Board");
    ...
    private void getBoardInfo() {
        ...
        FirebaseRecyclerAdapter<MembersInfo, BoardViewHolder> adapter = new FirebaseRecyclerAdapter<MembersInfo, BoardActivity.BoardViewHolder>(options) {


            @Override
            protected void onBindViewHolder(@NonNull final BoardActivity.BoardViewHolder boardViewHolder, int i, @NonNull MembersInfo membersInfo) {
                ...
                dRef.child(boardID).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild("name")) {
                            ...
                            boardViewHolder.mName.setText(name);
                            boardViewHolder.mPost.setText(post);
                            Glide.with(getApplicationContext()).load(profile_pic).into(boardViewHolder.mProfile);
                            boardViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
            ...
            @NonNull
            @Override
            public BoardActivity.BoardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.board_list_layout, parent, false);
                BoardActivity.BoardViewHolder boardViewHolder = new BoardActivity.BoardViewHolder(view);
    ...
    private static class BoardViewHolder extends RecyclerView.ViewHolder {
        ...
        public BoardViewHolder(@NonNull View itemView) {
            super(itemView);
            mProfile = itemView.findViewById(R.id.img_1_board);
            mName = itemView.findViewById(R.id.text_1_board);
            mPost = itemView.findViewById(R.id.post_1_board);
        }
